...
export default function CountdownTimer() {
  ...
  return (
    <section className="bg-primary text-secondary py-8 px-4 sm:py-16 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-bold mb-8">
          Countdown to Our Big Day!
        </h2>
        <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-3xl sm:text-4xl md:text-6xl font-bold">
